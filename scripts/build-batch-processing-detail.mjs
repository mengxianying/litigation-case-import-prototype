...
function buildErrorCategorySheet(workbook) {
  ...
  formatTable(sheet, 1,
    ...
    [
      ...
      ['导入前校验', '必填列缺失、订单编号为空等行级问题', '写入订单处理明细，不影响其它订单导入', '订单编号为空', '订单编号为空：模板中订单编号不能为空，请修正后重新上传。\n缺少必填列：模板缺少必填列【列名】，请修正后重新上传。', '修正问题行后通过编辑或批量补传重新上传'],
...
buildDetailSheet(workbook, '订单处理明细',
  ...
  [
    ['DR202606100001', '创新', textId('26012915050167612327'), null, '张三', '处理成功', '-', '-', '已生效', '材料齐全', '否', '无需补传', '-', '2026-06-10 20:15:32', '2026-06-10 20:16:08'],
    ['DR202606100001', '创新', textId('26012915050167612328'), textId('26012915050167610001'), '黄丽', '待材料补齐', '缺少必填材料', '缺少必填材料：租赁服务合同', '待材料激活', '待补必填', '是', '仅上传材料包（必填）', '租赁服务合同', '2026-06-10 20:15:32', '2026-06-10 20:16:08'],
    ['DR202606100001', '创新', textId('26012915050167612331'), null, '周强', '处理成功', '缺少非必填材料', '缺少非必填材料：担保合同', '已生效', '待补非必填', '是', '仅上传材料包（非必填）', '担保合同', '2026-06-10 20:15:32', '2026-06-11 10:08:16'],
    ['DR202606100001', '创新', '', null, '吴空', '导入失败', '导入前校验', '模板中订单编号不能为空，请修正后重新上传。', '-', '未生成', '是', '仅上传订单 Excel', '-', '2026-06-10 20:15:32', '2026-06-11 10:05:38'],
    ['DR202606100001', '创新', textId('26012915050167612330'), null, '李明', '导入失败', '字段格式错误', '身份证号格式错误', '-', '未生成', '是', '仅上传订单 Excel', '-', '2026-06-10 20:15:32', '2026-06-11 10:06:42'],
    ['DR202606100001', '创新', textId('26012915050167612333'), null, '赵倩', '重复跳过', '重复跳过', '原案件已分配或已流转，系统自动跳过，不可覆盖。', '已生效', '未生成', '否', '无需补传', '-', '2026-06-10 20:15:32', '2026-06-11 10:08:18'],
    ['DR202605080001', '创新', textId('26012915050167612018'), null, '刘洋', '处理成功', '-', '-', '已生效', '材料齐全', '否', '无需补传', '-', '2026-05-08 16:30:21', '2026-07-20 10:02:31'],
  ],
...
buildDetailSheet(workbook, '材料处理明细',
  ...
  [
    ...
    ['DR202606100001', textId('26012915050167612328'), '黄丽', '主合同', '租赁服务合同', '必填', '精确', null, '待补必填', '缺少必填材料：租赁服务合同', '2026-06-10 20:16:08'],
    ['DR202606100001', textId('26012915050167612331'), '周强', '担保合同', '保证合同', '非必填', '包含', null, '待补非必填', '缺少非必填材料：担保合同', '2026-06-11 10:08:16'],
